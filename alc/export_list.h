...
DeclareFuncAlias(alcCreateContext);
DeclareFuncAlias(alcMakeContextCurrent);
DeclareFuncAlias(alcProcessContext);
DeclareFuncAlias(alcSuspendContext);
DeclareFuncAlias(alcDestroyContext);
DeclareFuncAlias(alcGetCurrentContext);
DeclareFuncAlias(alcGetContextsDevice);
DeclareFuncAlias(alcOpenDevice);
DeclareFuncAlias(alcCloseDevice);
DeclareFuncAlias(alcGetError);
DeclareFuncAlias(alcIsExtensionPresent);
DeclareFuncAlias(alcGetProcAddress);
DeclareFuncAlias(alcGetEnumValue);
DeclareFuncAlias(alcGetString);
DeclareFuncAlias(alcGetIntegerv);
DeclareFuncAlias(alcCaptureOpenDevice);
DeclareFuncAlias(alcCaptureCloseDevice);
DeclareFuncAlias(alcCaptureStart);
DeclareFuncAlias(alcCaptureStop);
DeclareFuncAlias(alcCaptureSamples);

DeclareFuncAlias(alcSetThreadContext);
DeclareFuncAlias(alcGetThreadContext);

DeclareFuncAlias(alcLoopbackOpenDeviceSOFT);
DeclareFuncAlias(alcIsRenderFormatSupportedSOFT);
DeclareFuncAlias(alcRenderSamplesSOFT);

DeclareFuncAlias(alcDevicePauseSOFT);
DeclareFuncAlias(alcDeviceResumeSOFT);

DeclareFuncAlias(alcGetStringiSOFT);
DeclareFuncAlias(alcResetDeviceSOFT);

DeclareFuncAlias(alcGetInteger64vSOFT);

DeclareFuncAlias(alcReopenDeviceSOFT);

DeclareFuncAlias(alcEventIsSupportedSOFT);
DeclareFuncAlias(alcEventControlSOFT);
DeclareFuncAlias(alcEventCallbackSOFT);

DeclareFuncAlias(alEnable);
DeclareFuncAlias(alDisable);
DeclareFuncAlias(alIsEnabled);
DeclareFuncAlias(alGetString);
DeclareFuncAlias(alGetBooleanv);
DeclareFuncAlias(alGetIntegerv);
DeclareFuncAlias(alGetFloatv);
DeclareFuncAlias(alGetDoublev);
DeclareFuncAlias(alGetBoolean);
DeclareFuncAlias(alGetInteger);
DeclareFuncAlias(alGetFloat);
DeclareFuncAlias(alGetDouble);
DeclareFuncAlias(alGetError);
DeclareFuncAlias(alIsExtensionPresent);
DeclareFuncAlias(alGetProcAddress);
DeclareFuncAlias(alGetEnumValue);
DeclareFuncAlias(alListenerf);
DeclareFuncAlias(alListener3f);
DeclareFuncAlias(alListenerfv);
DeclareFuncAlias(alListeneri);
DeclareFuncAlias(alListener3i);
DeclareFuncAlias(alListeneriv);
DeclareFuncAlias(alGetListenerf);
DeclareFuncAlias(alGetListener3f);
DeclareFuncAlias(alGetListenerfv);
DeclareFuncAlias(alGetListeneri);
DeclareFuncAlias(alGetListener3i);
DeclareFuncAlias(alGetListeneriv);
DeclareFuncAlias(alGenSources);
DeclareFuncAlias(alDeleteSources);
DeclareFuncAlias(alIsSource);
DeclareFuncAlias(alSourcef);
DeclareFuncAlias(alSource3f);
DeclareFuncAlias(alSourcefv);
DeclareFuncAlias(alSourcei);
DeclareFuncAlias(alSource3i);
DeclareFuncAlias(alSourceiv);
DeclareFuncAlias(alGetSourcef);
DeclareFuncAlias(alGetSource3f);
DeclareFuncAlias(alGetSourcefv);
DeclareFuncAlias(alGetSourcei);
DeclareFuncAlias(alGetSource3i);
DeclareFuncAlias(alGetSourceiv);
DeclareFuncAlias(alSourcePlayv);
DeclareFuncAlias(alSourceStopv);
DeclareFuncAlias(alSourceRewindv);
DeclareFuncAlias(alSourcePausev);
DeclareFuncAlias(alSourcePlay);
DeclareFuncAlias(alSourceStop);
DeclareFuncAlias(alSourceRewind);
DeclareFuncAlias(alSourcePause);
DeclareFuncAlias(alSourceQueueBuffers);
DeclareFuncAlias(alSourceUnqueueBuffers);
DeclareFuncAlias(alGenBuffers);
DeclareFuncAlias(alDeleteBuffers);
DeclareFuncAlias(alIsBuffer);
DeclareFuncAlias(alBufferData);
DeclareFuncAlias(alBufferf);
DeclareFuncAlias(alBuffer3f);
DeclareFuncAlias(alBufferfv);
DeclareFuncAlias(alBufferi);
DeclareFuncAlias(alBuffer3i);
DeclareFuncAlias(alBufferiv);
DeclareFuncAlias(alGetBufferf);
DeclareFuncAlias(alGetBuffer3f);
DeclareFuncAlias(alGetBufferfv);
DeclareFuncAlias(alGetBufferi);
DeclareFuncAlias(alGetBuffer3i);
DeclareFuncAlias(alGetBufferiv);
DeclareFuncAlias(alDopplerFactor);
DeclareFuncAlias(alDopplerVelocity);
DeclareFuncAlias(alSpeedOfSound);
DeclareFuncAlias(alDistanceModel);

DeclareFuncAlias(alGenFilters);
DeclareFuncAlias(alDeleteFilters);
DeclareFuncAlias(alIsFilter);
DeclareFuncAlias(alFilteri);
DeclareFuncAlias(alFilteriv);
DeclareFuncAlias(alFilterf);
DeclareFuncAlias(alFilterfv);
DeclareFuncAlias(alGetFilteri);
DeclareFuncAlias(alGetFilteriv);
DeclareFuncAlias(alGetFilterf);
DeclareFuncAlias(alGetFilterfv);
DeclareFuncAlias(alGenEffects);
DeclareFuncAlias(alDeleteEffects);
DeclareFuncAlias(alIsEffect);
DeclareFuncAlias(alEffecti);
DeclareFuncAlias(alEffectiv);
DeclareFuncAlias(alEffectf);
DeclareFuncAlias(alEffectfv);
DeclareFuncAlias(alGetEffecti);
DeclareFuncAlias(alGetEffectiv);
DeclareFuncAlias(alGetEffectf);
DeclareFuncAlias(alGetEffectfv);
DeclareFuncAlias(alGenAuxiliaryEffectSlots);
DeclareFuncAlias(alDeleteAuxiliaryEffectSlots);
DeclareFuncAlias(alIsAuxiliaryEffectSlot);
DeclareFuncAlias(alAuxiliaryEffectSloti);
DeclareFuncAlias(alAuxiliaryEffectSlotiv);
DeclareFuncAlias(alAuxiliaryEffectSlotf);
DeclareFuncAlias(alAuxiliaryEffectSlotfv);
DeclareFuncAlias(alGetAuxiliaryEffectSloti);
DeclareFuncAlias(alGetAuxiliaryEffectSlotiv);
DeclareFuncAlias(alGetAuxiliaryEffectSlotf);
DeclareFuncAlias(alGetAuxiliaryEffectSlotfv);

DeclareFuncAlias(alDeferUpdatesSOFT);
DeclareFuncAlias(alProcessUpdatesSOFT);

DeclareFuncAlias(alSourcedSOFT);
DeclareFuncAlias(alSource3dSOFT);
DeclareFuncAlias(alSourcedvSOFT);
DeclareFuncAlias(alGetSourcedSOFT);
DeclareFuncAlias(alGetSource3dSOFT);
DeclareFuncAlias(alGetSourcedvSOFT);
DeclareFuncAlias(alSourcei64SOFT);
DeclareFuncAlias(alSource3i64SOFT);
DeclareFuncAlias(alSourcei64vSOFT);
DeclareFuncAlias(alGetSourcei64SOFT);
DeclareFuncAlias(alGetSource3i64SOFT);
DeclareFuncAlias(alGetSourcei64vSOFT);

DeclareFuncAlias(alGetStringiSOFT);

DeclareFuncAlias(alBufferStorageSOFT);
DeclareFuncAlias(alMapBufferSOFT);
DeclareFuncAlias(alUnmapBufferSOFT);
DeclareFuncAlias(alFlushMappedBufferSOFT);

DeclareFuncAlias(alEventControlSOFT);
DeclareFuncAlias(alEventCallbackSOFT);
DeclareFuncAlias(alGetPointerSOFT);
DeclareFuncAlias(alGetPointervSOFT);

DeclareFuncAlias(alBufferCallbackSOFT);
DeclareFuncAlias(alGetBufferPtrSOFT);
DeclareFuncAlias(alGetBuffer3PtrSOFT);
DeclareFuncAlias(alGetBufferPtrvSOFT);

DeclareFuncAlias(alSourcePlayAtTimeSOFT);
DeclareFuncAlias(alSourcePlayAtTimevSOFT);

DeclareFuncAlias(alBufferSubDataSOFT);

DeclareFuncAlias(alBufferDataStatic);

DeclareFuncAlias(alDebugMessageCallbackEXT);
DeclareFuncAlias(alDebugMessageInsertEXT);
DeclareFuncAlias(alDebugMessageControlEXT);
DeclareFuncAlias(alPushDebugGroupEXT);
DeclareFuncAlias(alPopDebugGroupEXT);
DeclareFuncAlias(alGetDebugMessageLogEXT);
DeclareFuncAlias(alObjectLabelEXT);
DeclareFuncAlias(alGetObjectLabelEXT);
DeclareFuncAlias(alGetPointerEXT);
DeclareFuncAlias(alGetPointervEXT);

DeclareFuncAlias(alcGetProcAddress2);
DeclareFuncAlias(alEnableDirect);
DeclareFuncAlias(alDisableDirect);
DeclareFuncAlias(alIsEnabledDirect);
DeclareFuncAlias(alDopplerFactorDirect);
DeclareFuncAlias(alSpeedOfSoundDirect);
DeclareFuncAlias(alDistanceModelDirect);
DeclareFuncAlias(alGetStringDirect);
DeclareFuncAlias(alGetBooleanvDirect);
DeclareFuncAlias(alGetIntegervDirect);
DeclareFuncAlias(alGetFloatvDirect);
DeclareFuncAlias(alGetDoublevDirect);
DeclareFuncAlias(alGetBooleanDirect);
DeclareFuncAlias(alGetIntegerDirect);
DeclareFuncAlias(alGetFloatDirect);
DeclareFuncAlias(alGetDoubleDirect);

DeclareFuncAlias(alGetErrorDirect);
DeclareFuncAlias(alIsExtensionPresentDirect);
DeclareFuncAlias(alGetProcAddressDirect);
DeclareFuncAlias(alGetEnumValueDirect);

DeclareFuncAlias(alListeneriDirect);
DeclareFuncAlias(alListener3iDirect);
DeclareFuncAlias(alListenerivDirect);
DeclareFuncAlias(alListenerfDirect);
DeclareFuncAlias(alListener3fDirect);
DeclareFuncAlias(alListenerfvDirect);
DeclareFuncAlias(alGetListeneriDirect);
DeclareFuncAlias(alGetListener3iDirect);
DeclareFuncAlias(alGetListenerivDirect);
DeclareFuncAlias(alGetListenerfDirect);
DeclareFuncAlias(alGetListener3fDirect);
DeclareFuncAlias(alGetListenerfvDirect);

DeclareFuncAlias(alGenBuffersDirect);
DeclareFuncAlias(alDeleteBuffersDirect);
DeclareFuncAlias(alIsBufferDirect);
DeclareFuncAlias(alBufferDataDirect);
DeclareFuncAlias(alBufferiDirect);
DeclareFuncAlias(alBuffer3iDirect);
DeclareFuncAlias(alBufferivDirect);
DeclareFuncAlias(alBufferfDirect);
DeclareFuncAlias(alBuffer3fDirect);
DeclareFuncAlias(alBufferfvDirect);
DeclareFuncAlias(alGetBufferiDirect);
DeclareFuncAlias(alGetBuffer3iDirect);
DeclareFuncAlias(alGetBufferivDirect);
DeclareFuncAlias(alGetBufferfDirect);
DeclareFuncAlias(alGetBuffer3fDirect);
DeclareFuncAlias(alGetBufferfvDirect);

DeclareFuncAlias(alGenSourcesDirect);
DeclareFuncAlias(alDeleteSourcesDirect);
DeclareFuncAlias(alIsSourceDirect);
DeclareFuncAlias(alSourcePlayDirect);
DeclareFuncAlias(alSourceStopDirect);
DeclareFuncAlias(alSourcePauseDirect);
DeclareFuncAlias(alSourceRewindDirect);
DeclareFuncAlias(alSourcePlayvDirect);
DeclareFuncAlias(alSourceStopvDirect);
DeclareFuncAlias(alSourcePausevDirect);
DeclareFuncAlias(alSourceRewindvDirect);
DeclareFuncAlias(alSourceiDirect);
DeclareFuncAlias(alSource3iDirect);
DeclareFuncAlias(alSourceivDirect);
DeclareFuncAlias(alSourcefDirect);
DeclareFuncAlias(alSource3fDirect);
DeclareFuncAlias(alSourcefvDirect);
DeclareFuncAlias(alGetSourceiDirect);
DeclareFuncAlias(alGetSource3iDirect);
DeclareFuncAlias(alGetSourceivDirect);
DeclareFuncAlias(alGetSourcefDirect);
DeclareFuncAlias(alGetSource3fDirect);
DeclareFuncAlias(alGetSourcefvDirect);
DeclareFuncAlias(alSourceQueueBuffersDirect);
DeclareFuncAlias(alSourceUnqueueBuffersDirect);

DeclareFuncAlias(alGenFiltersDirect);
DeclareFuncAlias(alDeleteFiltersDirect);
DeclareFuncAlias(alIsFilterDirect);
DeclareFuncAlias(alFilteriDirect);
DeclareFuncAlias(alFilterivDirect);
DeclareFuncAlias(alFilterfDirect);
DeclareFuncAlias(alFilterfvDirect);
DeclareFuncAlias(alGetFilteriDirect);
DeclareFuncAlias(alGetFilterivDirect);
DeclareFuncAlias(alGetFilterfDirect);
DeclareFuncAlias(alGetFilterfvDirect);
DeclareFuncAlias(alGenEffectsDirect);
DeclareFuncAlias(alDeleteEffectsDirect);
DeclareFuncAlias(alIsEffectDirect);
DeclareFuncAlias(alEffectiDirect);
DeclareFuncAlias(alEffectivDirect);
DeclareFuncAlias(alEffectfDirect);
DeclareFuncAlias(alEffectfvDirect);
DeclareFuncAlias(alGetEffectiDirect);
DeclareFuncAlias(alGetEffectivDirect);
DeclareFuncAlias(alGetEffectfDirect);
DeclareFuncAlias(alGetEffectfvDirect);
DeclareFuncAlias(alGenAuxiliaryEffectSlotsDirect);
DeclareFuncAlias(alDeleteAuxiliaryEffectSlotsDirect);
DeclareFuncAlias(alIsAuxiliaryEffectSlotDirect);
DeclareFuncAlias(alAuxiliaryEffectSlotiDirect);
DeclareFuncAlias(alAuxiliaryEffectSlotivDirect);
DeclareFuncAlias(alAuxiliaryEffectSlotfDirect);
DeclareFuncAlias(alAuxiliaryEffectSlotfvDirect);
DeclareFuncAlias(alGetAuxiliaryEffectSlotiDirect);
DeclareFuncAlias(alGetAuxiliaryEffectSlotivDirect);
DeclareFuncAlias(alGetAuxiliaryEffectSlotfDirect);
DeclareFuncAlias(alGetAuxiliaryEffectSlotfvDirect);

DeclareFuncAlias(alDeferUpdatesDirectSOFT);
DeclareFuncAlias(alProcessUpdatesDirectSOFT);
...
DeclareFuncAlias(alUnmapBufferDirectSOFT);
DeclareFuncAlias(alFlushMappedBufferDirectSOFT);

DeclareFuncAlias(alSourcei64DirectSOFT);
DeclareFuncAlias(alSource3i64DirectSOFT);
DeclareFuncAlias(alSourcei64vDirectSOFT);
DeclareFuncAlias(alSourcedDirectSOFT);
DeclareFuncAlias(alSource3dDirectSOFT);
DeclareFuncAlias(alSourcedvDirectSOFT);
DeclareFuncAlias(alGetSourcei64DirectSOFT);
DeclareFuncAlias(alGetSource3i64DirectSOFT);
DeclareFuncAlias(alGetSourcei64vDirectSOFT);
DeclareFuncAlias(alGetSourcedDirectSOFT);
DeclareFuncAlias(alGetSource3dDirectSOFT);
DeclareFuncAlias(alGetSourcedvDirectSOFT);
DeclareFuncAlias(alSourcePlayAtTimeDirectSOFT);
DeclareFuncAlias(alSourcePlayAtTimevDirectSOFT);
...
DeclareFuncAlias(alDebugMessageControlDirectEXT);
DeclareFuncAlias(alPushDebugGroupDirectEXT);
DeclareFuncAlias(alPopDebugGroupDirectEXT);
DeclareFuncAlias(alGetDebugMessageLogDirectEXT);
DeclareFuncAlias(alObjectLabelDirectEXT);
DeclareFuncAlias(alGetObjectLabelDirectEXT);
DeclareFuncAlias(alGetPointerDirectEXT);
DeclareFuncAlias(alGetPointervDirectEXT);

#if ALSOFT_EAX
DeclareFuncAlias(EAXGet);
DeclareFuncAlias(EAXSet);
DeclareFuncAlias(EAXGetBufferMode);
DeclareFuncAlias(EAXSetBufferMode);
DeclareFuncAlias(EAXGetDirect);
DeclareFuncAlias(EAXSetDirect);
DeclareFuncAlias(EAXGetBufferModeDirect);
DeclareFuncAlias(EAXSetBufferModeDirect);
#endif
#undef DeclareFuncAlias

#else

#define GetFuncPtr(x) reinterpret_cast<void*>(&x)
#endif
...
#define DECL(x) FuncExport{#x, GetFuncPtr(x)}
inline const auto alcFunctions = std::to_array({
    ...
    /* Extra functions */
    FuncExport{"alsoft_set_log_callback", reinterpret_cast<void*>(&alsoft_set_log_callback)},
});
#if ALSOFT_EAX
